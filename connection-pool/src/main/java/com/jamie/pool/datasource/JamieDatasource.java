 ...
 * @author jamie
 * @version 1.0.0
 * @description 数据源 接口 主要目的对于Demo 非核心部分进行默认实现
 * @date 2023/7/10 00:41
 */
public interface JamieDatasource extends DataSource {

    public static Logger LOGGER = Logger.getLogger(JamieDatasource.class.getName());
    ...
    default void setLoginTimeout(int seconds) throws SQLException {
        System.out.println("set LoginTimeout: " + seconds);
    }
